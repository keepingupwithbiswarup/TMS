...
const TimeEntryModal: React.FC<TimeEntryModalProps> = ({ visible, onClose }) => {
    ...
    const saveTimesheet = async () => {
        ...
        try {
            const response = await fetch(`http://${IpRoute}/api/createtimesheet`, {
                method: 'POST',
                headers: {
            ...
            if (response.ok) {
                ...
                Alert.alert('Error', result.error || 'Failed to create timesheet.');
            }
        } catch (error) {
            ...
            <SafeAreaView style={styles.modalContainer}>
                <View style={styles.modalContent}>
                    <View style={styles.headerContainer}>
                        <Text style={styles.headerTitle}>New Timesheet Entry</Text>
